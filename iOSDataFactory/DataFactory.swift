...
public final class DataFactory {
    ...
    public func getRandomChars(length: Int) -> String? {
        return self.getRandomChars(from: length, to: length)
    }
    
    public func getRandomChars(from minLength: Int, to maxLength: Int) -> String? {
        guard minLength > 0 && minLength <= maxLength else { return nil }
    ...
    public func getRandomText(length: Int) -> String? {
        return self.getRandomText(from: length, to: length)
    }
    
    public func getRandomText(from minLength: Int, to maxLength: Int) -> String? {
        guard minLength > 0 && minLength <= maxLength else { return nil }
    ...
    public func getRandomWord(length: Int) -> String? {
        return self.getRandomWord(from: length, to: length)
    }
    
    public func getRandomWord(from minLength: Int, to maxLength: Int) -> String? {
        guard minLength > 0 && minLength <= maxLength else { return nil }
